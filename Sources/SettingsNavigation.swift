...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "per-pane-shell-history", String(localized: "settings.terminal.perPaneShellHistory", defaultValue: "Per-Pane Shell History"), "terminal.perPaneShellHistory per pane shell history histfile isolated separate command history zsh bash up arrow recall"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.perPaneShellHistory": settingID(for: .terminal, idSuffix: "per-pane-shell-history"),
